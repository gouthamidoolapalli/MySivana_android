...
public class MSPasswordEditText extends AppCompatEditText {
    ...
    public MSPasswordEditText(Context context) {
        super(context);
        init(null);
    }

    public MSPasswordEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MSPasswordEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            int fontName = typedArray.getInt(R.styleable.PasswordView_useStrikeThrough, 0);
