...
public class MSCircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.color_primary_radius;
    ...
    public MSCircleIndicator(Context context) {
        super(context);
        init(context, null);
    }

    public MSCircleIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MSCircleIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MSCircleIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable,
                        R.drawable.color_primary_radius);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.color_primary_radius, R.drawable.gray_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.color_primary_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
