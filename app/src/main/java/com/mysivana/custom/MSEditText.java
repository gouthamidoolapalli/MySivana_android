...
public class MSEditText extends TextInputEditText {
    public MSEditText(Context context) {
        super(context);
    }

    public MSEditText(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MSEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
